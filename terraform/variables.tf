...
variable "k3s_version" {
  type    = string
  default = "v1.36.1+k3s1" # renovate: datasource=github-releases depName=k3s-io/k3s
}
...
variable "oci_ccm_version" {
  type    = string
  default = "v1.34.1" # renovate: datasource=github-tags depName=oracle/oci-cloud-controller-manager
}
# https://github.com/kubernetes-csi/external-snapshotter/
variable "external_snapshotter_version" {
  type    = string
  default = "v8.6.0" # renovate: datasource=github-releases depName=kubernetes-csi/external-snapshotter
}
